...
//            jedisPoolConfig.setTestOnBorrow(SysConfigUtil.getSysConfigUtil("redis.properties").getBoolean("redis.testOnBorrow"));
    ...
    public static void main(String[] args) {
        ...
        StringBuffer sql = new StringBuffer("select * from CODE_PINYINSTORE where word in ('");
        for(int i=0;i<0;i++){
            sql.append(i).append("','");
        }
...
//        String[] xs = new String[cs.length];
//        for (int i=0;i<cs.length;i++){
//            xs[i] = String.valueOf(cs[i]);
//        }
//
//        for (String s : xs) {
...
//
//        String[] word = {"行","弹","参","山","会","嬅"};
//        List<String> list = jedis.hmget("REDIS.ICPSP.CODE_PINYINSTORE", word);
...
//        for (String s : list) {
//            if (s == null) {
//                throw new RuntimeException("汉字：["+word[list.indexOf(s)]+"]在拼音库中未找到对应拼音。");
//            } else {
//                result.add(s.split(","));
//            }
//        }
